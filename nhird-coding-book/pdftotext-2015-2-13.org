...
# /A-'$A_f'/,/A-'$A_l'/  { print $2, $4}  # fails
 /A-$A_f/,/A-$A_l/ {print \$4}  # works  "a shell here-is document"
...
# /A-20/,/A-23/   # works
# /A-20/,/A-23/  { print , , NR, NF }  # works
# /A-'20'/,/A-'22'/  # works
# /A-'20'/,/A-'22'/  { print , }  # fails
 /A-20/,/A-22/ {print $4}  # works  a shell here-is document
# /A-20/,/A-22/ {print '', ''}  # fails, empty in single qoute
# /A-'20'/,/A-'22'/ {print $2, $4}  # fails, extra single qoute in awk_script
# /A-20/,/A-22/  { print , }  # fails
